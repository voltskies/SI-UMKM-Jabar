...
// Daftar dokumen legalitas yang dibutuhkan - tinggal tambah/kurangi di sini kalau ada penyesuaian
...
// Status dummy - nanti diganti data asli dari backend (hasil acc admin)
// 'belum' | 'diajukan' | 'diverifikasi' | 'disetujui' | 'ditolak'
...
export default function Sertifikasi({ onKembali }) {
  const [view, setView] = useState('dashboard'); // 'dashboard' | 'form'
  const [dataLegalitas, setDataLegalitas] = useState(statusAwalDummy);

  const [dataPemohon, setDataPemohon] = useState({ nik: '', nama_lengkap: '', email: '', nomor_whatsapp: '', nama_usaha: '' });
  ...
  const handleSubmitForm = (e) => {
    ...
    const wajibBelumLengkap = syaratLegalitas
      .filter((d) => d.id !== 'surat_izin') // surat_izin opsional
    ...
    // Simulasi submit (backend & dashboard admin menyusul)
        ...
        <div style={{ maxWidth: '760px', margin: '0 auto' }}>
          ...
          <button
            ...
            style={{
              ...
              background: 'none', border: 'none', color: '#164E43',
              fontWeight: '700', fontSize: '0.9rem', cursor: 'pointer', marginBottom: '20px'
            }}
          >
          ...
          {dataLegalitas.status === 'belum' && (
            <div style={{ backgroundColor: '#FFFFFF', border: '1px dashed #CBD5E1', borderRadius: '16px', padding: '32px', textAlign: 'center' }}>
              ...
              <button
                onClick={bukaForm}
                style={{
                  backgroundColor: '#164E43', color: '#FFFFFF', border: 'none', borderRadius: '10px',
          ...
          {/* STATUS: SUDAH DIAJUKAN / SEDANG DIPROSES ADMIN */}
          {(dataLegalitas.status === 'diajukan' || dataLegalitas.status === 'diverifikasi') && (
            <div style={{
              ...
              boxShadow: '0 4px 6px -1px rgba(0,0,0,0.03)', padding: '28px'
            }}>
              ...
              <div style={{ marginTop: '20px', backgroundColor: '#F8FAFC', border: '1px solid #F1F5F9', borderRadius: '10px', padding: '14px', fontSize: '0.8rem', color: '#64748B' }}>
                Dokumen Anda sedang diperiksa oleh admin Dinas KUK. Anda akan mendapat notifikasi setelah ada keputusan.
              </div>
            </div>
          )}
          ...
          {dataLegalitas.status === 'disetujui' && (
            <div style={{
              backgroundColor: '#FFFFFF', borderRadius: '16px', border: '1px solid #BBF7D0',
          ...
          {dataLegalitas.status === 'ditolak' && (
            <div style={{ backgroundColor: '#FFFFFF', borderRadius: '16px', border: '1px solid #FECACA', padding: '28px' }}>
              ...
              <button
                onClick={bukaForm}
                style={{
                  marginTop: '10px', backgroundColor: '#164E43', color: '#FFFFFF', border: 'none',
                  borderRadius: '10px', padding: '12px 24px', fontWeight: '700', fontSize: '0.88rem', cursor: 'pointer'
                }}
              >
                Ajukan Ulang
              </button>
    ...
    <div style={{ backgroundColor: '#F8FAFC', minHeight: '100vh', padding: '40px 20px', fontFamily: 'Inter, system-ui, sans-serif' }}>
      <div style={{ maxWidth: '760px', margin: '0 auto' }}>
        ...
        <div style={{ backgroundColor: '#FFFFFF', borderRadius: '16px', border: '1px solid #E2E8F0', boxShadow: '0 10px 25px -5px rgba(0,0,0,0.05)', padding: '36px' }}>
          ...
          {errorForm && (
            <div style={{
              display: 'flex', alignItems: 'center', gap: '10px', backgroundColor: '#FEF2F2',
              border: '1px solid #F87171', color: '#991B1B', padding: '12px 16px', borderRadius: '8px',
          ...
          <form onSubmit={handleSubmitForm}>
            ...
            <button
              type="submit"
              style={{
                width: '100%', backgroundColor: '#164E43', color: '#FFFFFF', border: 'none',
                borderRadius: '10px', padding: '14px', fontWeight: '700', fontSize: '0.95rem',
                cursor: 'pointer', boxShadow: '0 4px 14px rgba(22, 78, 67, 0.25)'
              }}
            >
      ...
      {nomorSukses && (
        <div style={{
          ...
          <div style={{
            backgroundColor: '#FFFFFF', borderRadius: '16px', padding: '36px', maxWidth: '440px',
            width: '100%', textAlign: 'center', boxShadow: '0 20px 25px -5px rgba(0,0,0,0.2)'
          }}>
            ...
            <p style={{ fontSize: '0.85rem', color: '#64748B', lineHeight: '1.5', margin: '0 0 20px' }}>
              Dokumen Anda akan diverifikasi oleh admin. Simpan nomor registrasi ini:
            </p>
            <div style={{
              backgroundColor: '#F8FAFC', border: '2px dashed #164E43', borderRadius: '8px',
              padding: '12px', fontSize: '1.1rem', fontWeight: '800', color: '#164E43',
              letterSpacing: '1px', marginBottom: '24px'
            }}>
              {nomorSukses}
            </div>
            <button onClick={tutupModalSukses} style={{
              width: '100%', backgroundColor: '#164E43', color: '#FFFFFF', border: 'none',
